...
AC_CustomControl_ADRC::AC_CustomControl_ADRC(AC_CustomControl &frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl_Multi*& atti_control, AP_MotorsMulticopter*& motors, float dt) :
...
Vector3f AC_CustomControl_ADRC::update(void)
{
    ...
    Vector3f rate_target = _atti_control->rate_bf_targets();
